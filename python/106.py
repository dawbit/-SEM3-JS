...
file = open("raport_"+str(now.year)+str(now.month)+str(now.day)+".txt", 'w')
print("RAPORT ALGORYTMOW SORTOWANIA:", file=file)
print("SORTOWANIE:   LICZBA SORTOWANYCH LICZB:          CZAS:  ", file=file)
print("Babelkowe:    ",len(A),"                       ", czasBubble, file=file)
print("Wstawianie:   ",len(A),"                       ", czasInsert, file=file)
print("quick sort:      ",len(A),"                       ", koniecQ, file=file)
file.close()